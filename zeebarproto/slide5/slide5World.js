...
function slide5World(id, ht) {
	var txt = '<h1>Can you make the Home buttons follow you around?<br>Like a puppy dog following you wherever you go...</h1>'; 
...
callback2(screens.indexOf('slide5') + 1);